...
# smtpObj = smtplib.SMTP( [mail.abiel.com [, 25 [, mail.abiel.com]]] )

# smtpObj = smtplib.SMTP( [localhost [, 25 [, localhost]]] )

Here is the detail of the parameters:

host: This is the host running your SMTP server.
You can specifiy IP address of the host or a domain name like "mail.abiel.com" or "192.168.234.100"
...
then you can specify just localhost or "mail.abiel.com" as of this option.
...
**********************************************************************   
Note: Here, you have placed a basic e-mail in message, using a triple quote, taking care to format the headers correctly. An e-mail requires a From, To, and Subject header, separated from the body of the e-mail with a blank line.
...
message = """From: From Person <root@server.example.com>
To: To Person <keshav.kummari@server.example.com>
MIME-Version: 1.0
...
reciever = 'keshav.kummari@server.example.com'
...
part1 = """From: From Person <root@server.example.com>
To: To Person <keshav.kummari@server.example.com>
